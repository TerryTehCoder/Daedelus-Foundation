 ...
 *	Exclusive, can only be ordered from logistics, you cant refill them.
 */
...
/obj/item/reagent_containers/glass/bottle/syrup_bottle/liqueur
	...
	desc = "A pump bottle containing mexican coffee-flavoured liqueur syrup. If you're serious about your work here, you'll probably need this."
