/obj/structure/flag_base
	...
	icon_state = "pole48" // Default pole icon state for 48px height
	var/flag_icon = 'icons/obj/flags.dmi'
	var/flag_icon_state = "flag_default"
	layer = ABOVE_OBJ_LAYER
	var/current_pole_height = 48 // Current pole height in pixels
...
/obj/structure/flag_base/proc/update_flag_overlay()
	...
	flag_overlay.pixel_y = current_pole_height - min_pole_height // Position flag relative to pole top
...
/obj/structure/flag_base/attack_hand(mob/user)
	...
	if(current_pole_height < max_pole_height)
		...
		playsound(loc, 'sound/structures/safe_toggle.ogg', 50, 1)
		update_flag_overlay()
