...
/datum/self_destruct_profile/self_destruct_explosion_profile/proc/on_final_destruction_signal(datum/self_destruct_controller/controller_instance, data = null)
	SIGNAL_HANDLER
	message_admins(span_adminnotice("Self-destruct Explosion Profile: on_final_destruction_signal received data: [data]"))
...
/datum/self_destruct_profile/self_destruct_explosion_profile/proc/process_explosion_logic(obj/machinery/nuclearbomb/N)
	message_admins(span_adminnotice("Self-destruct Explosion Profile: process_explosion_logic called for [N]."))
	if(!N.core)
	...
	message_admins(span_adminnotice("Self-destruct Explosion Profile: Calling initiate_final_explosion with off_station [off_station]."))
...
/datum/self_destruct_profile/self_destruct_explosion_profile/proc/initiate_final_explosion(off_station, obj/machinery/nuclearbomb/N)
	message_admins(span_adminnotice("Self-destruct Explosion Profile: initiate_final_explosion called. off_station: [off_station]."))
	var/turf/bomb_location = get_turf(N)
